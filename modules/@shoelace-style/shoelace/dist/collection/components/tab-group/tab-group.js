    ...
    render() {
        return (h("div", { part: "base", ref: el => (this.tabGroup = el), class: {
            ...
            h("div", { class: "tab-group__nav-container" },
                this.canScrollHorizontally && (h("sl-icon-button", { class: "tab-group__scroll-button tab-group__scroll-button--left", name: "chevron-left", onClick: this.handleScrollLeft })),
                h("div", { ref: el => (this.nav = el), key: "nav", part: "nav", class: "tab-group__nav", tabindex: "-1" },
                    h("div", { ref: el => (this.tabs = el), part: "tabs", class: "tab-group__tabs", role: "tablist" },
                        ...
                        h("slot", { name: "nav" }))),
                this.canScrollHorizontally && (h("sl-icon-button", { class: "tab-group__scroll-button tab-group__scroll-button--right", name: "chevron-right", onClick: this.handleScrollRight }))),

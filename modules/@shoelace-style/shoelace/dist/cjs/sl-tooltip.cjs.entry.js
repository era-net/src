...
const Tooltip = class {
    ...
    componentDidLoad() {
        ...
        this.popover = new popover.Popover(this.target, this.tooltip);
        this.syncOptions();
    ...
    render() {
        return (index.h(index.Host, { onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut }, index.h("slot", { "aria-describedby": this.componentId }), !this.disabled && (index.h("div", { part: "base", ref: el => (this.tooltip = el), id: this.componentId, class: {
                tooltip: true,

...
const Switch = class {
    ...
    render() {
        return (index.h("label", { part: "base", htmlFor: this.switchId, role: "switch", class: {
                switch: true,
                'switch--checked': this.checked,
                'switch--disabled': this.disabled,
                'switch--focused': this.hasFocus
            }, onMouseDown: this.handleMouseDown }, index.h("span", { part: "control", class: "switch__control" }, index.h("span", { part: "thumb", class: "switch__thumb" }), index.h("input", { ref: el => (this.input = el), id: this.switchId, type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-labeledby": this.labelId, onClick: this.handleClick, onBlur: this.handleBlur, onFocus: this.handleFocus, onKeyDown: this.handleKeyDown })), index.h("span", { part: "label", id: this.labelId, class: "switch__label" }, index.h("slot", null))));
    }

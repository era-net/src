    ...
    render() {
        ...
        const ColorPicker = () => {
            return (index.h("div", { part: "base", class: {
                ...
                }, "aria-disabled": this.disabled }, index.h("div", { part: "grid", class: "color-picker__grid", style: {
                    ...
                    left: `${this.alpha}%`
                }, role: "slider", "aria-label": "alpha", "aria-orientation": "horizontal", "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": Math.round(this.alpha), tabIndex: this.disabled ? null : 0, onKeyDown: this.handleAlphaKeyDown })))), index.h("div", { part: "preview", class: "color-picker__preview color-picker__transparent-bg", style: {
                    color: `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`
                } })), index.h("div", { class: "color-picker__user-input" }, index.h("sl-input", { ref: el => (this.textInput = el), part: "input", size: "small", type: "text", pattern: "[a-fA-F\\d]+", value: this.textInputValue, disabled: this.disabled, onKeyDown: this.handleTextInputKeyDown, onSlChange: this.handleTextInputChange }), index.h("sl-button", { ref: el => (this.copyButton = el), part: "copy-button", slot: "suffix", class: "color-picker__copy-button", size: "small", circle: true, onClick: this.handleCopy }, index.h("sl-icon", { name: this.showCopyCheckmark ? 'check2' : 'clipboard' }))), this.swatches && (index.h("div", { part: "swatches", class: "color-picker__swatches" }, this.swatches.map(swatch => (index.h("div", { part: "swatch", class: "color-picker__swatch color-picker__transparent-bg", tabIndex: this.disabled ? null : 0, role: "button", "aria-label": swatch, onClick: () => !this.disabled && this.setColor(swatch), onKeyDown: event => !this.disabled && event.key === 'Enter' && this.setColor(swatch) }, index.h("div", { class: "color-picker__swatch-color", style: { backgroundColor: swatch } }))))))));
        };
        // Render inline
        if (this.inline) {
        ...
        return (index.h("sl-dropdown", { ref: el => (this.dropdown = el), class: "color-dropdown", "aria-disabled": this.disabled, containingElement: this.host, onSlShow: this.handleDropdownShow, onSlAfterShow: this.handleDropdownAfterShow, onSlHide: this.handleDropdownHide, onSlAfterHide: this.handleDropdownAfterHide }, index.h("button", { ref: el => (this.trigger = el), slot: "trigger", class: {

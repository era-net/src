...
const Select = class {
    ...
    syncItemsFromValue() {
        ...
        if (this.multiple) {
            ...
            this.displayTags = checkedItems.map(item => {
                return (index.h("sl-tag", { type: "info", size: this.size, pill: this.pill, clearable: true, onClick: event => event.stopPropagation(), onSlClear: () => {
                        item.checked = false;
            ...
            if (this.maxTagsVisible > 0 && this.displayTags.length > this.maxTagsVisible) {
                ...
                this.displayTags.push(index.h("sl-tag", { type: "info", size: this.size }, "+", total - this.maxTagsVisible));
            }
            this.displayLabel = '';
        }
        else {
    ...
    render() {
        return (index.h("div", { part: "form-control", class: {
            ...
            }, htmlFor: this.inputId }, this.label), index.h("sl-dropdown", { part: "base", ref: el => (this.dropdown = el), closeOnSelect: !this.multiple, containingElement: this.host, class: {
                select: true,
